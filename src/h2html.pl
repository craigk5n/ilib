...
#
# History:
#	29-Nov-99	Craig Knudsen	cknudsen@cknudsen.com
...
#	29-May-96	Craig Knudsen	cknudsen@cknudsen.com
#			Created
#
#######################################################################
...
sub print_function {
  ...
  $out{$name} .= "<tt>$ret_type $name ( $args )</tt></p><p>\n";
  $out{$name} .= "$description</p><p>\n"
    if ( defined ( $description ) );
  $out{$name} .= "Returns: <tt>$ret_type</tt></p><p>\n" .
    "Input Parameters:</p>\n<ul>\n";
...
<tr><td>Author:</td>
  <td><a href="http://www.5kn.us/">Craig Knudsen</a>,
    <a href="mailto:craig\@k5n.us">craig\@k5n.us</a></td></tr>
