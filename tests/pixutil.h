...
static int px_width ( IImage im )
{
  return ( (IImageP *) im )->width;
}
static int px_height ( IImage im )
{
  return ( (IImageP *) im )->height;
}
static int px_grey ( IImage im )
{
  return ( (IImageP *) im )->greyscale;
}
